...
/**
 * Created by tandangfei on 2018/4/27 0027.
 */
public class XssReplacelHttpServletRequestWrapper extends HttpServletRequestWrapper {

	HttpServletRequest xssRequest = null;

	public XssReplacelHttpServletRequestWrapper(HttpServletRequest request) {
		super(request);
		xssRequest = request;
	}
